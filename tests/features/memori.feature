Feature: Memori
    ...
    Scenario: Click an unfliped memori card
        Given the player loads the following mock data:
            """
            | 1 |
            """
        And the memori card (1,1) is unfliped
        When the player click the memori card (1,1)
        Then the memori card (1,1) should be fliped:
            """
            | 1 |
            """

    Scenario: Disable a fliped memori card
        Given the player loads the following mock data:
            """
            | 1 |
            """
    ...
    Scenario: The fliped pair is correct - stay fliped and disabled
        Given the player loads the following mock data:
            """
            | 1 | 1 | 2 |
            """
        When the player click the memori card (1,3)
        Then the memori cards (1,1) and (1,2) should stay fliped

    Scenario: The fliped pair is incorrect - return to default memori card state
        Given the player loads the following mock data:
            """
            | 1 | 2 |
            """
        Then the memori cards (1,1) and (1,2) should be unfliped

    Scenario: Win the game - all the memori cards fliped
        Given the player loads the following mock data:
            """
            | 1 | 1 | 4 | 4 |
            | 2 | 2 | 5 | 5 |
        ...
        Then  all the memori cards should stay fliped
